...
export function Environment(name: string): BaseURL {
    return `https://${name}-nextjs-test-k6q2.encr.app`
}
...
/**
 * Client is an API client for the nextjs-test-k6q2 Encore application.
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "nextjs-test-k6q2-Generated-TS-Client (Encore/v1.46.4)";
        }
